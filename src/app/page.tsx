  ...
  return (
    <div className="container">
      <section className={css.section}>
        ...
        <p>Шановний отче Андрію!</p>
        <p className={css.paragraph}> Від щирого серця вітаємо Вас із Днем народження! Молитовно бажаємо Вам Божого благословення, міцного здоров&apos;я, душевного спокою, духовної радості та щедрої Божої допомоги у всіх добрих справах. Дякуємо Вам за Вашу невтомну працю на ниві Христовій. Нехай Господь щедро винагородить Вас за всі добрі труди, зміцнює у вірі, надії та любові, а Пресвята Богородиця завжди оберігає Вас Своїм святим покровом. Многая і благая літа!</p>  
