    ...
    <div className="container">
      <section className={css.section}>
        ...
        <p className={css.greeting}>
          Шановний отче Дмитре, щиро вітаємо Вас із Днем народження! Дякуємо за
          Ваше віддане служіння, постійну турботу та щиру молитву за всіх нас.
          Нехай Господь щедро благословляє Вас, укріплює у здоров’ї, дарує мир у
          серці, духовну радість і наснагу для подальших трудів на славу Божу.
        </p>
