      ...
      <section className={css.section}>
        ...
        {/* <div className={css.greeting}>
          ...
          <p className={css.paragraph}>
            {" "}
            Від щирого серця вітаємо Вас із Днем народження!
          </p>
          <p className={css.paragraph}>
            У цей святковий день бажаємо Вам щедрих Божих благословень, міцного
            здоров’я, духовної радості, душевного миру та невичерпних сил для
            подальшого пастирського служіння. Нехай Господь укріплює Вас у вірі,
            надії та любові, дарує мудрість і терпіння, допомагає у всіх добрих
            справах та примножує плоди Ваших трудів на благо Святої Церкви і
            нашої парафії.
          </p>
          <p className={css.paragraph}>
            Дякуємо Вам за Вашу невтомну працю, щиру молитву, духовне
            наставництво, турботу про храм і кожного, хто переступає його поріг.
            Нехай Господь за всі Ваші добрі труди та жертовне служіння сторицею
            воздає Своїми милостями.
          </p>
          <p className={css.paragraph}>
            Нехай Пресвята Богородиця завжди покриває Вас Своїм святим покровом,
            оберігає від усякого зла та веде під Своїм материнським
            заступництвом.
          </p>
          <p className={`${css.textBold} ${css.paragraph}`}>
            Бажаємо Вам, отче Олександре, многая і благая літа, міцності духу,
            миру, радості та Божої допомоги на всіх шляхах Вашого служіння!
          </p>
          <p className={`${css.textBold} ${css.paragraph}`}>
